/**
 * OctaStats — Shared JS utilities v3
 * Slider theme toggle, V1 overlay, GitHub data, formatting, nav.
 */
...
function applyTheme(theme) {
  ...
  // Update all slider toggles on page
...
function oddsChip(odds) {
  ...
  if (str === "n/a") return '<span class="odds-chip">' + str + '</span>';
...
// ── V1 Overlay system ─────────────────────────────────────────────────────────
// The V1 "site" lives inside a full-screen overlay div on each page.
// Clicking the V2/V1 toggle slides it in/out.
...
// Each page calls this to declare which V1 panel to show by default
...
function showV1Panel(panel) {
  ...
  document.querySelectorAll(".v1-subnav-tab").forEach(function(btn) {
